...
echo "  1. Ensure Node.js 18+ is installed (https://nodejs.org/)"
echo "  2. First run will auto-install API dependencies (4 packages, requires internet)"
echo "  3. Run ./dist/music_downloader/music_downloader"
echo "  4. Visit http://localhost:45600"
echo "============================================"
